...
private fun IrSimpleType.substituteTypeArguments(
    ...
    // java.lang.NoSuchMethodError: 'org.jetbrains.kotlin.ir.types.IrSimpleType org.jetbrains.kotlin.ir.types.impl.IrSimpleTypeImplKt.IrSimpleTypeImpl$default(
    //    org.jetbrains.kotlin.ir.symbols.IrClassifierSymbol,
    //    boolean,
    //    java.util.List,
    //    java.util.List,
    //    org.jetbrains.kotlin.ir.types.IrTypeAbbreviation,
    //    int,
    //    java.lang.Object)'

    // SimpleTypeNullability is an enum. (3 values)


    //IrSimpleTypeImpl(
    //        classifier, // org.jetbrains.kotlin.ir.symbols.IrClassifierSymbol - OK
    //        nullability, // SimpleTypeNullability <-> bool.
    //        arguments, // List<IrTypeArgument>
    //        annotations, // List<IrConstructorCall>
    //    )


    return IrSimpleTypeImpl(classifier, nullability, newArguments, annotations)
}
